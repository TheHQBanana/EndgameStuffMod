...
public class ContainerRubyFurnace extends Container {
	...
	public ContainerRubyFurnace(InventoryPlayer player, TileEntityRubyFurnace te) {
		this.te = te;
		/*this.addSlotToContainer(new Slot(te, 0, 40, 17));
		this.addSlotToContainer(new Slot(te, 1, 72, 17));
		this.addSlotToContainer(new SlotRubyFurnaceFuel(te, 2, 56, 53));
		this.addSlotToContainer(new SlotRubyFurnaceOutput(player.player, te, 3, 112, 31));*/
